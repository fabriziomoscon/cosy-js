...
(function() {
  ...
  assertFn = function(value, message) {
    ...
    return assert(value, message, isFn);
  };
...
require.define("/lib/core/native/assert.js",function(require,module,exports,__dirname,__filename,process,global){// Generated by CoffeeScript 1.3.3
(function() {
  'use strict';

  var assert;

  assert = function(value, message, predicate) {
    if (!(predicate(value))) {
...
(function() {
  ...
  assertArr = function(value, message) {
    ...
    return assert(value, message, isArr);
  };
...
(function() {
  ...
  var assertFn, assertStr, assoc, children, cosy, defProtocol, dispatch, doSeq, element, evaluate, extend, filter, frame, get, hashMap, isCosy, isStr, isTree, isTreeNode, list, lookup, lookupSymbol, map, parse, proto, root, stringify, supports, use, vec, _ref, _ref1, _ref2, _ref3, _ref4,
    __slice = [].slice,
    __hasProp = {}.hasOwnProperty;
  ...
  lookupSymbol = function(frame, parts) {
    var name, ref, rest;
    name = list.first(parts);
    rest = list.rest(parts);
    ref = get(frame, name);
    if (ref && rest) {
      return lookupSymbol(use(frame, ref), rest);
    } else {
      return ref;
    }
  };
...
(function() {
  ...
  assertStr = function(value, message) {
    ...
    return assert(value, message, isStr);
  };
...
(function() {
  ...
  var Cosy, Tree, TreeNode, attrs, cosy, css, data, dom, filter, get, getChildren, getCosy, getData, getElement, getNode, hashMap, into, isCosy, isCosyData, isTree, isTreeNode, key, loadNode, map, parseData, read, reduce, rest, second, value, _ref, _ref1, _ref2, _ref3,
    __hasProp = {}.hasOwnProperty;
  ...
  isCosy = function(type) {
    return type instanceof Cosy;
  };

  isTree = function(type) {
    return type instanceof Tree;
  };

  isTreeNode = function(type) {
    return type instanceof TreeNode;
  };
...
(function() {
  ...
  var assoc, control, core, cosy, evaluator, hashMap, reader, ref, snuggle,
    __hasProp = {}.hasOwnProperty;
  ...
  snuggle.up = function(startNode, controls, lib, debug) {
    ...
    return snuggle.up.to(startNode, frame);
  };

  snuggle.up.to = function(startNode, frame) {
...
(function() {
  ...
  var assert, assertObj, isArr, isObj;
  ...
  assertObj = function(value, message) {
    ...
    return assert(value, message, isObj);
  };
...
(function() {
  ...
  tags = ["a", "abbr", "address", "area", "article", "aside", "audio", "b", "base", "bdi", "bdo", "blockquote", "body", "br", "button", "canvas", "caption", "cite", "code", "col", "colgroup", "colgroup", "command", "datalist", "dd", "del", "details", "dfn", "div", "dl", "dt", "em", "embed", "fieldset", "figcaption", "figure", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "iframe", "img", "input", "ins", "kbd", "keygen", "label", "input", "legend", "details", "li", "link", "map", "mark", "menu", "meta", "meter", "nav", "noscript", "object", "ol", "optgroup", "option", "output", "p", "param", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "script", "section", "select", "small", "source", "audio", "span", "strong", "style", "sub", "summary", "details", "sup", "table", "tbody", "td", "textarea", "tfoot", "th", "thead", "time", "title", "tr", "track", "audio", "u", "ul", "var", "video", "wbr"];
...
(function() {
  ...
  var cosy, evaluator, hashMap, reader,
    __hasProp = {}.hasOwnProperty;
  ...
  cosy.up = function(startNode, imports) {
